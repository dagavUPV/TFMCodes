...
from objects_on_road_processor_new import ObjectsOnRoadProcessor
...
class DeepPiCar(object):
    ...
    def __init__(self):
        ...
        self.video_lane_complete = self.create_video_recorder('../data/tmp/car_video_lane_complete%s.avi' % datestr)
    ...
    def cleanup(self):
        ...
        self.video_lane_complete.release()
    ...
    def drive(self, speed=__INITIAL_SPEED):
        ...
        while self.camera.isOpened():
            ...
            image_lane, lane_complete_image = self.follow_lane(image_lane)
            self.video_lane.write(image_lane)
            self.video_lane_complete.write(lane_complete_image)
    ...
    def follow_lane(self, image):
        image, lane_complete_image = self.lane_follower.follow_lane(image)
        return image, lane_complete_image
